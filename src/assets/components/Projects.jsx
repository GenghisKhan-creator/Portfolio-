...
export default function SparklesPreview({animationScale, animationOpacity}) {
  return (
    <motion.div
      style={{scale: animationScale, opacity: animationOpacity}}
      className="h-80 w-full sticky top-0 bg-black font-Grotesk text-center mt-20 flex flex-col items-center justify-center overflow-hidden rounded-md">
      <h1
